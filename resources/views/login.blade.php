...
<div class="weui_cells weui_cells_form">
  ...
  <div class="weui_cell weui_vcode">
      ...
      <div class="weui_cell_ft">
          <img src="/bookshop/public/service/validate_code/create" class="bk_validate_code"/>
      </div>
  </div>
</div>
...
<script type="text/javascript">
  $('.bk_validate_code').click(function () {
    $(this).attr('src', '/bookshop/public/service/validate_code/create?random=' + Math.random());
  });
</script>
@endsection
